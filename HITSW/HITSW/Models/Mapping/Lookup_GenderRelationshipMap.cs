...
{
    public class Lookup_GenderRelationshipMap : EntityTypeConfiguration<Lookup_GenderRelationship>
    {
        public Lookup_GenderRelationshipMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.ToTable("Lookup_GenderRelationship");
            ...
            this.HasOptional(t => t.Lookup_Gender)
                .WithMany(t => t.Lookup_GenderRelationship)
