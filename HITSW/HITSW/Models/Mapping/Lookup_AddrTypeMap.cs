...
{
    public class Lookup_AddrTypeMap : EntityTypeConfiguration<Lookup_AddrType>
    {
        public Lookup_AddrTypeMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.ToTable("Lookup_AddrType");
            this.Property(t => t.Id).HasColumnName("Id");
            this.Property(t => t.VirtualType).HasColumnName("VirtualType");
