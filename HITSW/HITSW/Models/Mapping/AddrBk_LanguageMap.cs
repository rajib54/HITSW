...
{
    public class AddrBk_LanguageMap : EntityTypeConfiguration<AddrBk_Language>
    {
        public AddrBk_LanguageMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.Property(t => t.Language_LCID).HasColumnName("Language_LCID");
            ...
            this.HasRequired(t => t.Lookup_ContactBasis)
                .WithMany(t => t.AddrBk_Language)
                .HasForeignKey(d => d.ContactBasis_LCID);
            this.HasOptional(t => t.AddrBk_Person)
                .WithMany(t => t.AddrBk_Language)
                .HasForeignKey(d => d.IndivID);
            this.HasRequired(t => t.Lookup_Language)
                .WithMany(t => t.AddrBk_Language)
                .HasForeignKey(d => d.Language_LCID);
