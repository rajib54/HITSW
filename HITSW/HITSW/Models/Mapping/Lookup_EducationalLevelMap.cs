...
{
    public class Lookup_EducationalLevelMap : EntityTypeConfiguration<Lookup_EducationalLevel>
    {
        public Lookup_EducationalLevelMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.ToTable("Lookup_EducationalLevel");
