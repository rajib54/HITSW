...
{
    public class Lookup_StateProvinceMap : EntityTypeConfiguration<Lookup_StateProvince>
    {
        public Lookup_StateProvinceMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.ToTable("Lookup_StateProvince");
            ...
            this.HasRequired(t => t.Lookup_Country)
                .WithMany(t => t.Lookup_StateProvince)
