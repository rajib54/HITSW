...
{
    public class Lookup_VerificationTypeMap : EntityTypeConfiguration<Lookup_VerificationType>
    {
        public Lookup_VerificationTypeMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.ToTable("Lookup_VerificationType");
