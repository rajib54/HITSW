...
{
    public class Lookup_ContactBasisMap : EntityTypeConfiguration<Lookup_ContactBasis>
    {
        public Lookup_ContactBasisMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.Property(t => t.LastUpdatedrom)
                .HasMaxLength(50);
            ...
            this.ToTable("Lookup_ContactBasis");
            ...
            this.Property(t => t.LastUpdatedrom).HasColumnName("LastUpdatedrom");
