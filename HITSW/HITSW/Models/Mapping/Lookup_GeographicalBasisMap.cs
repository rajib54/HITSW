...
{
    public class Lookup_GeographicalBasisMap : EntityTypeConfiguration<Lookup_GeographicalBasis>
    {
        public Lookup_GeographicalBasisMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.ToTable("Lookup_GeographicalBasis");
